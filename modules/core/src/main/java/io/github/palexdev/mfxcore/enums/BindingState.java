...
/// Enumeration to identify the various states of a [IBinding]
public enum BindingState {

    /// This special state describes bindings that have just been created and have yet to  be activated.
    NULL,
    ...
    ///
    /// This is different from [#DISPOSED]!
    UNBOUND
}
