...
/// Public API every type of `Source` must implement.
///
/// The interface has two generics as it makes it easier to implement [MappingSources][MappingSource].
///
/// @param <S> the type of the source's observable
/// @param <T> the type of the target's observable
public interface ISource<S, T> {

    /// @return the source's [ObservableValue]
